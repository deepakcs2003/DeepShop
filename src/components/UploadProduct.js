...
export const UploadProduct = ({ onClose,fetchAllProducts }) => {
    const [productData, setProductData] = useState({
        productNAME: "",
        brandNAME: "",
        category: "", // Ensure this field is initialized
        productIMAGES: [],  // This will store Cloudinary URLs
        description: "",
        price: "",
        sellingPRICE: "",
    });
    ...
    const handleImageDelete = async (index) => {
        ...
        // Uncomment this block if you want to delete images from Cloudinary
        // if (imageToDelete && imageToDelete.public_id) {
        //     try {
        //         await deleteImage(imageToDelete.public_id); // Delete the image from Cloudinary
        //         console.log(`Deleted image with public_id: ${imageToDelete.public_id}`);
        //     } catch (error) {
